...
5. Text summarization, language translation, language generation : post-processing the data on the News headline of each ETF and ran through the NLP to classify either as positive, neutral and negative

6. Assigned the sentiment to the Dual Moving Average Dataframe to arrive at the buy and sell signals
...
## Pre-Requisites
In order to use this `Jupyter Lab` notebook, the packages below are pre-requisites
...
* Financial Technical Analysis `pip install finta`
